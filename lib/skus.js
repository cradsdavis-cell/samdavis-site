...
// Continuation Retainer added. Pay-in-4 surcharge SKUs use
...
const SKU_DEFS = {
  'single-session': { stripe_price_env: 'STRIPE_PRICE_SINGLE_V2', cal_event_env: 'CAL_EVENT_TYPE_SINGLE', label: 'Single Coaching Session', duration_min: 90, price_aud: 300 },
  'coaching-block': { stripe_price_env: 'STRIPE_PRICE_BLOCK_V2_FULL', cal_event_env: 'CAL_EVENT_TYPE_BLOCK', label: 'Coaching Block — Session 1', duration_min: 90, price_aud: 1000 },
  'coaching-block-pay4': { stripe_price_env: 'STRIPE_PRICE_BLOCK_V2_PAY4_FIRST', cal_event_env: 'CAL_EVENT_TYPE_BLOCK', label: 'Coaching Block — Session 1 (4 instalments)', duration_min: 90, price_aud: 1100 },
  'continuation-retainer': { stripe_price_env: 'STRIPE_PRICE_RETAINER', cal_event_env: 'CAL_EVENT_TYPE_RETAINER', label: 'Continuation Retainer (monthly)', duration_min: 90, price_aud: 650 },
};
