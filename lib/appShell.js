...
const NAV = [
  ...
  // the account exists to answer — who and what can reach my minerals — and it
  // is the only surface that can both show that and change it. Devices is now
  // the narrower view (machines and browser sessions), so it follows.
