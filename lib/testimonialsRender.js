...
(function () {
  ...
  function cardHTML(t) {
    ...
    var photo = t.photo
      ? '<img class="testimonial-photo" src="' + esc(t.photo) + '" alt="' + esc(t.name) + '" width="48" height="48" loading="lazy">'
      : '';
    return '<figure class="testimonial-card">'
      + '<blockquote>' + esc(t.quote) + '</blockquote>'
      + '<figcaption class="attribution">' + photo + '<span class="attribution-text">' + attr + '</span></figcaption>'
      + '</figure>';
  }
