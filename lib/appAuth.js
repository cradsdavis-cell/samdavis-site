...
function mintAppToken({ email, stateVersion, nonce, scope, accountId }) {
  ...
  return jwt.sign({
    ...
    // The `billing` claim was removed with the 2026-09-01 self-host pivot:
    // Crads is free and self-hosted, so nothing gates on a card any more.
    // The worker already treats an absent claim as false.
