...
// sessions, the interview between, 30 days of Slack support, then it's theirs. Extra time after that is A$233 an hour on request, not a product.
...
const AFTER_LINE = `After your 30 days of Slack support it's yours. You're welcome to invite Sam back into the chat whenever you like, at A$233 an hour.`;
