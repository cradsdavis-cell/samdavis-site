...
function renderHeroCard({ user, nextSession }) {
  ...
  switch (state) {
    ...
    case 'post-s4-decision':
      ...
      meta = `Want to continue? Retainer is A$750/mo — 2 sessions + async Slack. Most clients do 3-6 months.`;
    ...
    case 'graduated':
      ...
      meta = `Want to come back for a focused 60 min on something new?`;
